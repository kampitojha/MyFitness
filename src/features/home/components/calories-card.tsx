...
export function CaloriesCard({ consumed, goals }: CaloriesCardProps) {
  ...
  return (
    <View className="rounded-[24px] bg-surface p-5 shadow-sm dark:bg-neutral-900">
      <View className="items-center">
        ...
        <View className="mt-4 flex-row items-center justify-center gap-1.5 rounded-full bg-primary-soft px-4 py-1.5 dark:bg-emerald-900">
